...
- **Empresas:** CNPJ (validado), razão social, nome fantasia, tipo
  (operadora ou terceirizada), operadora contratante, contatos, endereço
  e situação (ativa/inativa).
...
documentos que vencem e acesso restrito a servidores (RLS).
